...
<head>
  ...
  <title>Indus Alumni</title>
  <link rel="stylesheet" href="./cssfolder/c1.php" type="text/css">
  <link rel="stylesheet" href="./temp/t1.css">
  ...
  <div class="main-body mt-4">
    ...
    <div class="p4" id="evewala">
      <div class="container">
            ...
            <div class="item">
              <div class="additional">
                ...
                <div class="more-info" style="margin-left: 30px; margin-right: 30px; text-align:left;">
                  ...
                  <span class="evepara"> <img class="locationicon" src="https://img.icons8.com/material-sharp/22/000000/marker.png" /><?php echo $everow['location'] . "</br>"; ?></span>
                  ...
                  <div class="evebuttonparent">
                    ...
                    <button type="submit" class="btn btn-primary mt-3 evebutton" onclick="location.href='./user_logedin/event_detail.php'">KNOW MORE</button>
                    <!-- <button type="submit" class="btn btn-primary mt-3 evebutton" onclick="location.href='#'">REGISTER</button> -->
                  </div>
                </div>
              </div>
              <div class="general">
        ...
        <div class="showextra">
          <button class="btn btn-primary mt-3" onclick="location.href='./user_logedin/allevents.php'">SHOW ALL <?php echo $counter; ?> EVENTS</button>
        </div>
    ...
    <div class="p6" id="jobwala">
      <div class="container">
              ...
              <div class="jobitem">
                <form method="POST">
                  ...
                  <div class="jobbtn">
                    ...
                    <button class="btn btn-primary mt-3" formaction="./user_logedin/job_details.php">SHOW DETAILS</button>
                  </div>
        ...
        <div class="showextrajob">
          <button class="btn btn-primary mt-3" onclick="location.href='./user_logedin/alljobs.php'">SHOW ALL <?php echo $jobcounternum; ?> JOB POSTINGS</button>
        </div>
                ...
                <div class="letter pt-2 active pb-0 px-3">
                  ...
                  <div class="collapse letter-more" id="a<?php echo $counternu; ?>">
                    ...
                    <?php if ($link == 0) { ?>
                      ...
                      <hr />
                    <?php } elseif ($link == 1) { ?>
                      <p><a class="pdflink" href="./logreg/login.php">Click here to show certification courses</a></p>
                    <?php } elseif ($link == 2) { ?>
                      <p><a class="pdflink" href="./logreg/login.php">Click here to show events</a></p>
                    <?php } elseif ($link == 3) { ?>
                      <p><a class="pdflink" href="./logreg/login.php">Click here to show jobs</a></p>
                    <?php } else { ?>
...
<!-- <h3 class="bl2 mt-4">This is main index page.</h3>
      <h4 class="bl2">here you can register and login with clicking to profile icon.</h4> -->