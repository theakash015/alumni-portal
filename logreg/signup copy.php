...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($email_err) && empty($password_err) && empty($confirm_password_err) && empty($fname_err) && empty($lname_err) && empty($phone_err) && empty($gender_err) && empty($role_err) && empty($err) && empty($degree_err) && empty($year_err) && empty($branch_err) && empty($institute_err) && empty($company_err) && empty($designation_err) && empty($country_err) && empty($city_err) && empty($enrolment_err)) {
        ...
        $sql = "INSERT INTO `users` (`first name`, `last name`, `email`, `gender`, `password`, `phoneno`, `role`, `enrolment`, `institute`, `branch`, `obtained degree`, `passout`, `company`, `designation`, `country`, `city`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = mysqli_prepare($conn, $sql);
        if ($stmt) {

            mysqli_stmt_bind_param($stmt, "ssssssssssssssss", $param_fname, $param_lname, $param_email, $param_gender, $param_password, $param_phone, $param_role, $param_enrolment, $param_institute, $param_brach, $param_degree, $param_year, $param_company, $param_designation, $param_country, $param_city);
    ...
    <div class="main-body">
        <div class="container">
            ...
            <div class="card">
                ...
                <!-- bootstart form  -->
                <form class="form needs-validation" action="./signup.php" method="POST" novalidate>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="form-group col-md-6">
                            <input required type="text" name="enrolment" class="form-control" placeholder="Enrolment Number">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="form-group col-md-6">
                            <select required name="role" id="role" class="form-select">
                                ...
                                <option value="2">Alumni / Passout</option>
                                <option value="3">Staff / Faculty</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-3">
                        <div class="form-group col-md-6">
                            <input type="text" name="company" class="form-control" placeholder="Current working company">
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" name="designation" class="form-control" placeholder="Work designation">
                        </div>
                    </div>
