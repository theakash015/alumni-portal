...
<body>
    ...
    <div class="main-body">
        <div class="container mt-4">
            ...
            <div class="card">
                <form class="form needs-validation" action="./includes/resetrequest.php" method="POST" novalidate>

                    <h3 class="bl">Reset your password</h3>
                    ...
                    ?>
                            ...
                            <div class="alert alert-success alert-dismissible fade show mt-3 " role="alert">
                                <strong class="msg"><?php echo "Check your email inbox for password reset link"; ?></strong>
                                <button type="button" class="btn-close btn-block" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                    ...
                    <button type="submit" name="resetrequestsubmit" class="btn btn-primary mt-3 " style="width: 100%;">RECEIVE NEW PASSWORD BY EMAIL</button>
