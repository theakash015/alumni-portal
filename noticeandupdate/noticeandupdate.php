...
<body>
    <header>
        <nav class="nav1 navbar navbar-light bg-light">
            <div class="">
                <!-- container-fluid -->
                <a class="navbar-brand" href="../user_logedin/">
        ...
        <nav id="navbar_top" class="nav2 navbar navbar-expand-xl navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav" id="">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="./noticeandupdate.php">Updates</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main-body">
        <div class="mt-4">
            <div class="container ">
                ...
                <?php
                $eve = "SELECT * FROM noticeandupdates ORDER BY srno DESC";
                ...
                while ($everow = mysqli_fetch_assoc($eve_q)) :
                    ...
                    $title =  $everow['title'];
                    $description =  $everow['description'];
                    $link =  $everow['link'];
                    $olddate =  $everow['createdAt'];
            ...
            <div class="p5">
                <div class="container">
                    ...
                    <div class="backgray ">
                        <a href="../user_logedin/addjobbyuser.php">
