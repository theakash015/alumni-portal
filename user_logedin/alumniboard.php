        ...
        <div class="mt-4">
            <div class="container ">
                ...
                <div class="gridpro">
                    ...
                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/abdjpg.jpg')"></div>

                        <h4>Dr APJ Kalam</h4>
                        <p class="protitle">Rocketman of INDIA</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/PM-Modi.jpg')"></div>

                        <h4>PM Narendra Modi</h4>
                        <p class="protitle">Prime minister of INDIA</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/kohli-ap-century-759.jpg')"></div>

                        <h4>Virat Kohli</h4>
                        <p class="protitle">The runmachine</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/swami.jpg')"></div>

                        <h4> Swami Vivekanand </h4>
                        <p class="protitle">Founder of Ramakrishna Mission</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/Dp0I7dsWkAEqb-V.jpg')"></div>

                        <h4>Mahi</h4>
                        <p class="protitle"> Great Cricketer </p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/sipdy.jpg')"></div>

                        <h4>Spiderman</h4>
                        <p class="protitle">Youngest Avenger</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/thanos-dd-single-image-thanos.jpg')"></div>

                        <h4>Thanos</h4>
                        <p class="protitle">The true hero</p>
                    </div>

                    <div class="procard itempro">

                        <div class="thumb" style="background-image: url('../imgfolder/arjit-songs-feature.jpg')"></div>

                        <h4>Arijit Singh</h4>
                        <p class="protitle">Most loved singer</p>
                    </div>
