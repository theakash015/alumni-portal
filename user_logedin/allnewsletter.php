    ...
    <div class="main-body">
        <div class="mt-4">
            <div class="container ">
                ...
                <?php
                $eve = "SELECT * FROM newsletter_two ORDER BY srno DESC";
                ...
                while ($everow = mysqli_fetch_assoc($eve_q)) :
                    ...
                    $title =  $everow['title'];
                    $link =  $everow['PDF'];
                    $olddate =  $everow['createdon'];
                    $newdate = date("d F Y", strtotime($olddate));

                ?>

                    <div class="letter pt-2 active pb-0 px-3">
                        <div class="letter-body row">
                            <div class=" col-md-10">
                                <h4 class="card-title "><b><?php echo $title; ?> </b></h4>
                            </div>
                            <div class=" col-md-2">
                                <h4 class="card-title "><a class="pdflink" href="<?php echo $link; ?>">PDF</a></h4>
                            </div>
                            <hr style="width:95%; margin: auto;" />
                            <h6 style="margin: 15px 0px 20px 14px;">Posted on: <?php echo $newdate; ?></h6>
