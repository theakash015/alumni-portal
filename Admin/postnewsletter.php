...
if (isset($_POST['send'])) {
    ...
    if (isset($_FILES['file'])) {
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000) {
                    $fileDestination = '../uploads/newsletters/' . $fileName;
    ...
    $q = "INSERT INTO `newsletter_two` (`title`, `PDF`) VALUES ('$newstitle', '$fileDestination')";
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <form class="form needs-validation" action="./postnewsletter.php" method="POST" enctype="multipart/form-data" novalidate>
                <?php
                if (isset($_POST['send'])) {
                    if (mysqli_stmt_execute($run)) {
                ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong class="msg"><?php echo "News letter posted sucessfully"; ?></strong>
                ...
                <h3 class="bl">Add Newsletter </h3>
                <div class="form-group row mt-3">
                    <div class="form-group col-md-12">
                        <input type="text" class="form-control" name="newstitle" id="newstitle" placeholder="Newsletter Title" required />
                    </div>
                </div>

                <div class="form-group row mt-3">
                    <div class="form-group col-md-12">
                        <label for="file">PDF or Image - Newsletter Details</label>
